...
- [ ] If a pay setting is queried, it shows in the search but clicking it does not open the pay settings modal and navigate to that setting yet
- [ ] Doesn't seem to be any search available for anything on the Key Metrics or Pay Breakdown views at all yet
- [ ] The search for specific components is working, but the scroll to view is still not working quite properly
