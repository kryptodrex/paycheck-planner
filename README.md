...
When a major **user-facing feature** is added, removed, or meaningfully changed, update this file in the same PR.

Quick checklist:
1. Add or edit the relevant section in **What You Can Do**.
2. Keep wording non-technical and user-focused.
3. Remove features that are no longer available.
4. Keep future ideas in `app_updates/APP_UPDATES.md` (not here).
