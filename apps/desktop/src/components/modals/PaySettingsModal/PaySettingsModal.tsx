...
import { CURRENCIES, getCurrencySymbol } from '@paycheck-planner/core/currency';
import { getDisplayModeLabel, getPaychecksPerYear, getPayFrequencyViewMode } from '@paycheck-planner/core/pay-period';
