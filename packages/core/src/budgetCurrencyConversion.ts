...
function convertCurrencyValue(value: number | undefined, exchangeRate: number): number | undefined {
...
export function convertBudgetAmounts<TSettings extends BudgetSettings>(
  data: BudgetData<TSettings>,
  exchangeRate: number,
): BudgetData<TSettings> {
  return {
    ...data,
    paySettings: {
      ...data.paySettings,
